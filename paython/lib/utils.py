...
CARD_TYPES = {
    'visa': {'cc': r'4\d{12}(\d{3})?$', 'cvv': r'^[\d+]{3}$'},
    'amex': {'cc': r'37\d{13}$', 'cvv': r'^[\d+]{4}$'},
    'mc': {'cc': r'5[1-5]\d{14}$', 'cvv': r'^[\d+]{3}$'},
    'discover': {'cc': r'6011\d{12}', 'cvv': r'^[\d+]{3}$'},
    'diners': {'cc': r'(30[0-5]\d{11}|(36|38)\d{12})$', 'cvv': r'^[\d+]{3}$'},
}
...
def is_valid_cvv(cc_cvv, type=None):
    """
